export const passwordResetRequestEmail = (otpCode: string, expirationMinutes: number) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Your LendBloc Password Reset OTP</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>This code will expire in <strong>${expirationMinutes} minutes</strong>. Please enter it promptly to reset your password.</p>
